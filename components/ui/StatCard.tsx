// StatCard — Dashboard statistic card with icon, title, and numeric value
// Used on the dashboard overview to display key metrics at a glance
...
// Displays a single stat metric with icon and animated hover effect
